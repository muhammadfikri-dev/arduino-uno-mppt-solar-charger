/**
 * =========================================================================================
 * Project     : Arduino Uno Synchronous Buck MPPT Solar Charge Controller
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Maximum Power Point Tracking solar charger implementing Perturb and Observe (P&O) and Incremental Conductance algorithms with high-frequency synchronous buck PWM.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Synchronous Buck MPPT Solar Charge Controller"));
